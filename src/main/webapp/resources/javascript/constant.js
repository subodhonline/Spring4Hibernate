var URL_CONSTANT = {
	LIST_PAGINATED_USERS_URL:window.location.protocol+"//"+ window.location.host+"/listPaginatedUser.htm",
	DELETE_USER_URL:window.location.protocol+"//"+ window.location.host+"/user/delete.htm",
};
...
var MESSAGE_CONSTANT = {
	...
	MESSAGE_SPECIAL_CHARACTER_NOT_ALLOWED : "Special characters are not allowed",
	...
	MESSAGE_PASSWORD_GREATER_THAN_FIFTEEN_CHARACTERS : "Password should not exceed 15 characters"
};
